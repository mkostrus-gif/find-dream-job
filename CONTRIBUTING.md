...
Изменения схемы v11 дополнительно проверяют миграцию v10→v11 с резервной
копией и сохранением P2-доказательств, append-only запись независимых transient
попыток, минимальный порог восстановления, отказ для средней или более длинной
хвостовой ошибки, login/CAPTCHA/access-denied/malformed страниц, незакрытой
detail-очереди и несовпадающих identity/config/query. Полный rollover должен
начинаться со страницы 0, принадлежать одной новой сессии, быть непрерывным и
завершённым; частичную новую сессию или смешение со старой принимать нельзя.
