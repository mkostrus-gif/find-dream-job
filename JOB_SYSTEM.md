...
Схема v10 обновляет все поддерживаемые версии v1–v9 и по умолчанию создаёт
...
Разрушающей обратной миграции нет. После обновления до v10 нельзя открывать базу
старой версией Engine: она не знает долговечный план запуска или инкрементальный
курсор и может нарушить координацию. Повторный `migrate-schema` для схемы v10
